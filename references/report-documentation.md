...
```bash
python3 "/absolute/skill/dir/scripts/document_gate.py" pass "/absolute/run/dir" \
...
```bash
python3 "/absolute/skill/dir/scripts/document_gate.py" fail "/absolute/run/dir" \
...
```bash
python3 "/absolute/skill/dir/scripts/document_gate.py" verify "/absolute/run/dir"
```
...
- Create the Bookforge project outside both skill packages, preferably at `<run_dir>/bookforge/`, and preserve it for rerendering.
...
The primary deliverables are the final PDF and `report.document-ready.md`. Also preserve `report.pre-document.md`, `report.document-readiness-gate.md`, `report.document-readiness-gate.json`, `sources.json`, and the Bookforge project as supporting run artifacts.
